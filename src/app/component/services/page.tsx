    ...
    return (
        <div  id="services"className="bg-gray-800 text-white">
            ...
            <div className="line border border-purple-800 text-white mx-4 "></div>
                ...
                <div className="w-80 h-48 lg:ml-12 hover:bg-purple-600 contrast-200 drop-shadow-xl my-2 mx-2 rounded-md cursor-pointer sm:w-[135vh] sm:h-36 sm:mx-6 md:flex md:w-[210vh] xl:w-[185vh]">
                    ...
                    <div>
                        <p className="mx-6 leading-12 translate-x-4 -tracking-tighter  md:mt-12  md:ml-28 text-wrap ">
                ...
                <div className="line border border-purple-800 text-white mx-4"></div>
                {/* 2nd Box */}
                <div className="w-80 h-48 lg:ml-12 hover:bg-purple-600 contrast-200 drop-shadow-xl my-2 mx-2 rounded-md cursor-pointer sm:w-[135vh] sm:mx-6 sm:h-36 md:flex md:w-[210vh] xl:w-[185vh]">
                    <div className="content flex ml-6  md:flex-none md: mt-8">
                    ...
                    <div>
                        <p className="mx-6 leading-12 translate-x-4 -tracking-tighter  md:mt-12  md:ml-40 text-wrap ">
                            Brolly show off show off pick your nose and blow off well A bit of how’s your father tomfoolery blimey, me old...
                        </p>
                    </div>
                ...
                <div className="w-80 h-48 lg:ml-12 hover:bg-purple-600 contrast-200 drop-shadow-xl my-2 mx-2 rounded-md cursor-pointer sm:w-[135vh] sm:mx-6 sm:h-36 md:flex md:w-[210vh] xl:w-[185vh]">
                    ...
                    <div>
                        <p className="mx-6 leading-12 translate-x-4 -tracking-tighter  md:mt-12  md:ml-48 text-wrap ">
                            Brolly show off show off pick your nose and blow off well A bit of how’s your father tomfoolery blimey, me old...
                        </p>
                    </div>
                </div>
                ...
                <div className="w-80 h-48 lg:ml-12 hover:bg-purple-600 contrast-200 drop-shadow-xl my-2 mx-2 rounded-md cursor-pointer sm:w-[135vh] sm:mx-6 sm:h-36 md:flex md:w-[210vh] xl:w-[185vh]">
                    ...
                    <div>
                        <p className="mx-6 leading-12 translate-x-4 -tracking-tighter  md:mt-12  md:ml-52 text-wrap ">
                            Brolly show off show off pick your nose and blow off well A bit of how’s your father tomfoolery blimey, me old...
                        </p>
                    </div>
                </div>
